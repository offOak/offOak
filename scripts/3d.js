...
const MODEL_PATH = "./model/44_logo_13.glb";
...
const BACKGROUND_COLOR = 0x101820;
// Init the scene
...
{ childID: "left_four", mtl: INITIAL_MTL },
{ childID: "right_four", mtl: INITIAL_MTL },
{ childID: "pillar_one", mtl: INITIAL_MTL },
{ childID: "pillar_two", mtl: INITIAL_MTL },
{ childID: "pillar_three", mtl: INITIAL_MTL }];
...
function initialRotation() {
  initRotate++;
  if (initRotate <= 300) {
    theModel.rotation.y += Math.PI / 150;
  } else {
    loaded = true;
  }
}
