$(document).ready(function updateGrid() {
if ($(window).width() < 750) {
...
let widthLessThan750 = $(window).width() < 750;

$(window).resize(function() {
  if ((widthLessThan750 && $(window).width() >= 750) || (!widthLessThan750 && $(window).width() < 750)) {
    location.assign(location.href);
  }
  widthLessThan750 = $(window).width() < 750;
});
