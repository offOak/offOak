(function() {
    const btn = document.getElementById("mobile__btn-debug");
  
    const foldsWrapper = document.getElementById("mobile__folds");
    const center = document.getElementById("mobile__fold-center");
    const bottom = document.getElementById("mobile__fold-bottom");
    const top = document.getElementById("mobile__fold-top");
    
    const baseContent = document.getElementById("mobile__base-content");
